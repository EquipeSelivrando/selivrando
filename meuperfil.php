...
<nav class="cd-main-nav">
	...
	<li><a href="frmCadastrolivro.php"><h2 class="menup">Adicionar Livro</h2></a></li>
...
<div class="bgperfil b2"> <!-- Exibir imagem de capa do perfil --> </div>

<!-- Se não ficar legal, usar h1 class="perfiltexto" pra voltar com a fonte da marca :) -->

<div class="bamarela">
<ul class="labelperfil">
<li class="labelperfil2"><h1 class="perfiltexto">Livros na Estante</h1></li>
<li class="labelperfil2"><h1 class="perfiltexto2">Usuários Favoritos</h1></li>
</ul>
</div>
...
<ul class="tablivros">
	 <li><div id= "livro1" >
	 	<a href="desclivro.php" class="button">12 anos de Escravidão</a>
